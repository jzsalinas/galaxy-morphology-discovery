...
class ManifestContractTripwireOutcomeTests(Base):
    ...
    def test_88_no_production_directories_mutated(self):
        ...
        observational_multiplicity_grouping_gate = observational_multiplicity_runtime_binding | {
            "OC3_GROUPING_GATE_ASSESSMENT_CANDIDATE_001.json",
            "OC3_GROUPING_GATE_ASSESSMENT_CANDIDATE_VALIDATION_001.json"}
        cross_observer_grouping_bootstrap = observational_multiplicity_grouping_gate | {
            "OC3_CROSS_OBSERVER_GROUPING_AUTONOMY_MANDATE_001.json",
            "OC3_CROSS_OBSERVER_GROUPING_DOCUMENTARY_FEASIBILITY_CANDIDATE_001.json",
            "OC3_CROSS_OBSERVER_GROUPING_DOCUMENTARY_FEASIBILITY_CANDIDATE_VALIDATION_001.json",
            "OC3_CROSS_OBSERVER_GROUPING_DOCUMENTARY_RESOURCE_MANIFEST_001.json",
            "OC3_CROSS_OBSERVER_GROUPING_POLICY_CORE_MANIFEST_001.json"}
        cross_observer_grouping_provenance_v2 = cross_observer_grouping_bootstrap | {
            "OC3_CROSS_OBSERVER_GROUPING_AUTONOMY_MANDATE_002.json",
            "OC3_CROSS_OBSERVER_GROUPING_DOCUMENTARY_FEASIBILITY_CANDIDATE_002.json",
            "OC3_CROSS_OBSERVER_GROUPING_DOCUMENTARY_FEASIBILITY_CANDIDATE_VALIDATION_002.json",
            "OC3_CROSS_OBSERVER_GROUPING_DOCUMENTARY_RESOURCE_MANIFEST_002.json",
            "OC3_CROSS_OBSERVER_GROUPING_POLICY_CORE_MANIFEST_002.json"}
        cross_observer_grouping_datalab_diagnostic = cross_observer_grouping_provenance_v2 | {
        ...
        cross_observer_grouping_primary_literature = cross_observer_grouping_documentary_completion | {
            "OC3_CROSS_OBSERVER_GROUPING_PRIMARY_LITERATURE_RECOVERY_CANDIDATE_001.json",
            "OC3_CROSS_OBSERVER_GROUPING_PRIMARY_LITERATURE_RECOVERY_MANIFEST_001.json",
            "OC3_CROSS_OBSERVER_GROUPING_PRIMARY_LITERATURE_RECOVERY_VALIDATION_001.json"}
        cross_observer_grouping_offline_review = cross_observer_grouping_primary_literature | {
            "OC3_CROSS_OBSERVER_GROUPING_OFFLINE_DOCUMENTARY_REVIEW_CANDIDATE_001.json",
            "OC3_CROSS_OBSERVER_GROUPING_OFFLINE_DOCUMENTARY_REVIEW_VALIDATION_001.json"}
        cross_observer_grouping_primary_article = cross_observer_grouping_offline_review | {
            "OC3_CROSS_OBSERVER_GROUPING_PRIMARY_ARTICLE_RECOVERY_CANDIDATE_002.json",
            "OC3_CROSS_OBSERVER_GROUPING_PRIMARY_ARTICLE_RECOVERY_MANIFEST_002.json",
            "OC3_CROSS_OBSERVER_GROUPING_PRIMARY_ARTICLE_RECOVERY_VALIDATION_002.json"}
        cross_id_formalism_recovery_bootstrap = cross_observer_grouping_primary_article | {
            "OC3_CROSS_ID_FORMALISM_RECOVERY_AUTONOMY_MANDATE_001.json",
            "OC3_CROSS_ID_FORMALISM_RECOVERY_FIRST_CANDIDATE_001.json",
            "OC3_CROSS_ID_FORMALISM_RECOVERY_FIRST_CANDIDATE_VALIDATION_001.json",
            "OC3_CROSS_ID_FORMALISM_RECOVERY_POLICY_CORE_MANIFEST_001.json",
            "OC3_CROSS_ID_FORMALISM_RECOVERY_RESOURCE_MANIFEST_001.json"}
        cross_id_formalism_route_hardening = cross_id_formalism_recovery_bootstrap | {
        ...
        cross_id_offline_review_recovery = cross_id_formalism_offline_review | {
            "OC3_CROSS_ID_OFFLINE_REVIEW_RECOVERY_AUTONOMY_MANDATE_001.json",
            "OC3_CROSS_ID_OFFLINE_REVIEW_RECOVERY_FIRST_CANDIDATE_001.json",
            "OC3_CROSS_ID_OFFLINE_REVIEW_RECOVERY_FIRST_CANDIDATE_VALIDATION_001.json",
            "OC3_CROSS_ID_OFFLINE_REVIEW_RECOVERY_POLICY_CORE_MANIFEST_001.json"}
        source_metadata_descriptive_pilot = cross_id_offline_review_recovery | {
            "OC3_SOURCE_METADATA_DESCRIPTIVE_PILOT_AUTONOMY_MANDATE_001.json",
            "OC3_SOURCE_METADATA_DESCRIPTIVE_PILOT_FIRST_CANDIDATE_001.json",
            "OC3_SOURCE_METADATA_DESCRIPTIVE_PILOT_FIRST_CANDIDATE_VALIDATION_001.json",
            "OC3_SOURCE_METADATA_DESCRIPTIVE_PILOT_POLICY_CORE_MANIFEST_001.json"}
        source_metadata_pilot_frame_recovery = source_metadata_descriptive_pilot | {
            "OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_AUTONOMY_MANDATE_001.json",
            "OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_CANDIDATE_001.json",
            "OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_CANDIDATE_VALIDATION_001.json",
            "OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_POLICY_CORE_MANIFEST_001.json"}
        source_metadata_pilot_frame_schema_recovery = source_metadata_pilot_frame_recovery | {
            "OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_AUTONOMY_MANDATE_001.json",
            "OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_CANDIDATE_001.json",
            "OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_CANDIDATE_VALIDATION_001.json",
            "OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_POLICY_CORE_MANIFEST_001.json"}
        source_metadata_acquisition_pilot = source_metadata_pilot_frame_schema_recovery | {
            "OC3_SOURCE_METADATA_ACQUISITION_DOCUMENTARY_PROVENANCE_001.json",
            "OC3_SOURCE_METADATA_ACQUISITION_DOCUMENTARY_PROVENANCE_002.json",
            "OC3_SOURCE_METADATA_ACQUISITION_PILOT_AUTONOMY_MANDATE_001.json",
            "OC3_SOURCE_METADATA_ACQUISITION_PILOT_CANDIDATE_001.json",
            "OC3_SOURCE_METADATA_ACQUISITION_PILOT_CANDIDATE_VALIDATION_001.json",
            "OC3_SOURCE_METADATA_ACQUISITION_PILOT_POLICY_CORE_MANIFEST_001.json",
            "OC3_SOURCE_METADATA_ACQUISITION_QUERY_MANIFEST_001.json"}
        source_metadata_autonomous_recovery = source_metadata_acquisition_pilot | {
            "OC3_SOURCE_METADATA_AUTONOMOUS_RECOVERY_MANDATE_001.json",
            "OC3_SOURCE_METADATA_AUTONOMOUS_RECOVERY_POLICY_CORE_MANIFEST_001.json",
            "OC3_SOURCE_METADATA_MUTABLE_TECHNICAL_SURFACE_001.json",
            "OC3_SOURCE_METADATA_RECOVERY_ACTION_REGISTRY_001.json",
            "OC3_SOURCE_METADATA_RECOVERY_BUDGET_001.json",
            "OC3_SOURCE_METADATA_RECOVERY_FIRST_CANDIDATE_001.json",
        ...
        source_metadata_autonomous_recovery_run_003 = source_metadata_autonomous_recovery_run_002 | {
            "OC3_SOURCE_METADATA_AUTONOMOUS_RECOVERY_MANDATE_003.json",
            "OC3_SOURCE_METADATA_AUTONOMOUS_RECOVERY_POLICY_CORE_MANIFEST_003.json",
            "OC3_SOURCE_METADATA_AUTONOMOUS_RECOVERY_RUN_002_CLOSURE_001.json",
            "OC3_SOURCE_METADATA_RECOVERY_ACTION_REGISTRY_003.json",
            "OC3_SOURCE_METADATA_RECOVERY_FIRST_CANDIDATE_003.json",
            "OC3_SOURCE_METADATA_RECOVERY_FIRST_CANDIDATE_VALIDATION_003.json"}
        ...
        self.assertIn(input_names, (input_base, eligibility_implementation,
                                    ...
                                    observational_multiplicity_grouping_gate,
                                    ...
                                    cross_observer_grouping_primary_literature,
                                    cross_observer_grouping_offline_review,
                                    ...
                                    cross_id_offline_review_recovery,
                                    source_metadata_descriptive_pilot,
                                    source_metadata_pilot_frame_recovery,
                                    source_metadata_pilot_frame_schema_recovery,
                                    source_metadata_acquisition_pilot,
                                    source_metadata_autonomous_recovery,
                                    source_metadata_autonomous_recovery_run_002,
                                    source_metadata_autonomous_recovery_run_003,
                                    eligibility_p0))
