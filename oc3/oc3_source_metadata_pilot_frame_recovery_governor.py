#!/usr/bin/env python3
"""Offline CLI for the frozen OC3 supervised pilot-frame recovery governor."""
...
from oc3lib.source_metadata_pilot_frame_recovery_governor import (
...
def parser() -> argparse.ArgumentParser:
    result=argparse.ArgumentParser(description="Deterministic offline OC3 pilot-frame recovery autonomy governor")
