...
MISSION_ID = "OC3-SOURCE-METADATA-FRAME-RECOVERY-AUTONOMY-001"
MISSION_SCOPE = "OFFLINE_PILOT_FRAME_RECOVERY_ONLY"
AUTONOMY_BRANCH = "autopilot/source-metadata-frame-recovery"
...
SCIENTIFIC_SPEC_PATH = PROJECT / "OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_SPEC_001.md"
SCIENTIFIC_SPEC_SHA256 = "2c56345ec5cb8e254fbd916a1fc5296d4b3ba1b282e683f11f536d2df3d5d13c"
POLICY_CORE_CONTRACT_PATH = PROJECT / "OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_AUTONOMY_POLICY_CORE_CONTRACT_001.md"
POLICY_CORE_MANIFEST_PATH = PROJECT / "oc3/INPUTS/OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_POLICY_CORE_MANIFEST_001.json"
MANDATE_DOCUMENT_PATH = PROJECT / "OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_AUTONOMY_MANDATE_001.md"
MANDATE_PATH = PROJECT / "oc3/INPUTS/OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_AUTONOMY_MANDATE_001.json"
RUNBOOK_PATH = PROJECT / "OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_AUTONOMOUS_RESEARCH_RUNBOOK_001.md"
STANDING_AUTHORIZATION_PATH = PROJECT / "oc3/OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_STANDING_AUTHORIZATION_001.json"
AUTHORIZATION_PATH = STANDING_AUTHORIZATION_PATH
STATE_PATH = PROJECT / "oc3/OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_AUTONOMY_STATE_001.json"
LEDGER_ROOT = PROJECT / "oc3/SOURCE_METADATA_PILOT_FRAME_RECOVERY_AUTONOMY_LEDGER"
CONSUMPTION_ROOT = LEDGER_ROOT / "PERMIT_CONSUMPTION"
PRIOR_FINAL_REPORT_PATH = PROJECT / "OC3_SOURCE_METADATA_DESCRIPTIVE_PILOT_STOP_REPORT_001.md"
PRIOR_FINAL_REPORT_SHA256 = "3e108bb586e083b67de5c040a2ae4eb0f94022604b12e781e1798d102392aae9"
PRIOR_CLAIM_MATRIX_PATH = PROJECT / "oc3/OC3_SOURCE_METADATA_DESCRIPTIVE_PILOT_AUTONOMY_STATE_001.json"
PRIOR_CLAIM_MATRIX_SHA256 = "ba45ad1f3a5f1f3dfa3a821d83dd18b68324f14a9d6270606fb65d1eec6257e1"
PRIOR_TERMINAL_STATE_PATH = PROJECT / "oc3/SOURCE_METADATA_DESCRIPTIVE_PILOT_AUTONOMY_PERMITS/OC3_SOURCE_METADATA_PILOT_FRAME_PERMIT_001.json"
PRIOR_TERMINAL_STATE_SHA256 = "8e96a042d50e436b9fbd8ee65ccd53be5d9e2ae9a6152968511d7faa001a0f4d"
PRIOR_CONSUMPTION_MARKER_PATH = PROJECT / "oc3/SOURCE_METADATA_DESCRIPTIVE_PILOT_AUTONOMY_LEDGER/PERMIT_CONSUMPTION/8e96a042d50e436b9fbd8ee65ccd53be5d9e2ae9a6152968511d7faa001a0f4d.json"
PRIOR_CONSUMPTION_MARKER_SHA256 = "70a22ada30ca459c939440750a562eec657dd7b72a6cb83b417d8fb1b2b433ef"

TERMINAL_OUTCOMES = (
    "SOURCE_METADATA_PILOT_FRAME_RECOVERED",
    "SOURCE_METADATA_PILOT_FRAME_RECOVERY_INTEGRITY_FAILED",
    "SOURCE_METADATA_PILOT_FRAME_RECOVERY_INCONCLUSIVE",
)
AUTHORITY_CLASSES = (
...
POLICY_CORE_MEMBERS = (
    "OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_AUTONOMY_POLICY_CORE_CONTRACT_001.md",
    "oc3/oc3_source_metadata_pilot_frame_recovery_governor.py",
    "oc3/oc3lib/source_metadata_pilot_frame_recovery_governor.py",
)
...
def validate_policy_core_manifest(path: Path = POLICY_CORE_MANIFEST_PATH) -> dict[str, object]:
    ...
    if (set(value) != {"active_mutation_result", "contract", "files", "schema_version", "sealed"} or
            value.get("schema_version") != "OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_POLICY_CORE_MANIFEST_001" or
...
def validate_mandate(path: Path = MANDATE_PATH) -> dict[str, object]:
    ...
    if (set(value) != required or value.get("schema_version") != "OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_AUTONOMY_MANDATE_001" or
            ...
            value.get("autonomous_action_contract") != "OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_ACTION_CONTRACT_001" or
...
def validate_state(path: Path = STATE_PATH) -> dict[str, object]:
    ...
    if (set(value) != required or value.get("schema_version") != "OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_AUTONOMY_STATE_001" or
...
def validate_standing_authorization(path: Path, *, expected_initial_state_sha256: str,
    ...
    if (set(value) != required or value.get("schema_version") != "OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_STANDING_AUTHORIZATION_001" or
...
def validate_action_validation_receipt(binding: object, contract: dict[str, object]) -> dict[str, object]:
    ...
    if (set(receipt) != required or receipt.get("schema_version") != "OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_ACTION_VALIDATION_RECEIPT_001" or
...
def validate_autonomous_action_candidate(path: Path) -> tuple[dict[str, object], dict[str, object]]:
    ...
    if (not isinstance(contract, dict) or set(contract) != required or
            contract.get("schema_version") != "OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_ACTION_CONTRACT_001" or
...
def _registered_binding(candidate_path: Path, candidate: dict[str, object], contract: dict[str, object], *, first=False) -> dict[str, object]:
    return {"action_contract_schema":"OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_ACTION_CONTRACT_001","action_kind":contract["action_kind"],
...
def build_permit(*, candidate_path: Path, state_path: Path, standing_authorization_path: Path,
    ...
    return sealed({"action_kind":contract["action_kind"],"authorization_basis":"STANDING_SOURCE_METADATA_PILOT_FRAME_RECOVERY_AUTONOMY_MANDATE_001",
        ...
        "schema_version":"OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_EXECUTION_PERMIT_001","scientific_firewall":contract["scientific_firewall"],
...
def validate_permit(permit_path: Path, *, candidate_path: Path, state_path: Path,
    ...
    if (set(permit) != required or permit.get("schema_version") != "OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_EXECUTION_PERMIT_001" or
            permit.get("permit_type") != "AUTONOMOUS_EXECUTION_PERMIT" or
            permit.get("authorization_basis") != "STANDING_SOURCE_METADATA_PILOT_FRAME_RECOVERY_AUTONOMY_MANDATE_001" or
