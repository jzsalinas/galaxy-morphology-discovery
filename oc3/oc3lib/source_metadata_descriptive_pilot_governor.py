...
MISSION_SCOPE = "SOURCE_METADATA_DESCRIPTIVE_PILOT_ONLY"
AUTONOMY_BRANCH = "autopilot/source-metadata-descriptive-pilot"
...
SCIENTIFIC_SPEC_PATH = PROJECT / "OC3_SOURCE_METADATA_DESCRIPTIVE_PILOT_SPEC_001.md"
SCIENTIFIC_SPEC_SHA256 = "8a227c270f17f5b907b6e4c2d267a0eb1d3c75754f85de2295dddd8b8122b212"
POLICY_CORE_CONTRACT_PATH = PROJECT / "OC3_SOURCE_METADATA_DESCRIPTIVE_PILOT_AUTONOMY_POLICY_CORE_CONTRACT_001.md"
POLICY_CORE_MANIFEST_PATH = PROJECT / "oc3/INPUTS/OC3_SOURCE_METADATA_DESCRIPTIVE_PILOT_POLICY_CORE_MANIFEST_001.json"
MANDATE_DOCUMENT_PATH = PROJECT / "OC3_SOURCE_METADATA_DESCRIPTIVE_PILOT_AUTONOMY_MANDATE_001.md"
MANDATE_PATH = PROJECT / "oc3/INPUTS/OC3_SOURCE_METADATA_DESCRIPTIVE_PILOT_AUTONOMY_MANDATE_001.json"
RUNBOOK_PATH = PROJECT / "OC3_SOURCE_METADATA_DESCRIPTIVE_PILOT_AUTONOMOUS_RESEARCH_RUNBOOK_001.md"
STANDING_AUTHORIZATION_PATH = PROJECT / "oc3/OC3_SOURCE_METADATA_DESCRIPTIVE_PILOT_STANDING_AUTHORIZATION_001.json"
AUTHORIZATION_PATH = STANDING_AUTHORIZATION_PATH
STATE_PATH = PROJECT / "oc3/OC3_SOURCE_METADATA_DESCRIPTIVE_PILOT_AUTONOMY_STATE_001.json"
LEDGER_ROOT = PROJECT / "oc3/SOURCE_METADATA_DESCRIPTIVE_PILOT_AUTONOMY_LEDGER"
CONSUMPTION_ROOT = LEDGER_ROOT / "PERMIT_CONSUMPTION"
PRIOR_FINAL_REPORT_PATH = PROJECT / "OC3_CROSS_ID_OFFLINE_REVIEW_RECOVERY_FINAL_REPORT_001.md"
PRIOR_FINAL_REPORT_SHA256 = "92cb93731594b044d7005675f44b6656500108cc44850780224baf223d817a72"
PRIOR_CLAIM_MATRIX_PATH = PROJECT / "oc3/OC3_CROSS_ID_OFFLINE_REVIEW_RECOVERY_FINAL_CLAIM_MATRIX_001.json"
PRIOR_CLAIM_MATRIX_SHA256 = "cee289e6a330cd237be1ae6c2aebfbe8fa321dc60d28ef5c6562ebe13d9376eb"
PRIOR_TERMINAL_STATE_PATH = PROJECT / "oc3/OC3_CROSS_ID_OFFLINE_REVIEW_RECOVERY_AUTONOMY_STATE_001.json"
PRIOR_TERMINAL_STATE_SHA256 = "4595b322605ad3c16afeac379e7a67d3c0add3c02718c51d406dc28c2f8d9b85"

TERMINAL_OUTCOMES = (
    "SOURCE_METADATA_DESCRIPTIVE_PILOT_COMPLETED",
    "SOURCE_METADATA_DESCRIPTIVE_PILOT_RESOURCE_BOUND",
    "SOURCE_METADATA_DESCRIPTIVE_PILOT_INCONCLUSIVE",
    "SOURCE_METADATA_DESCRIPTIVE_PILOT_INTEGRITY_FAILED",
)
AUTHORITY_CLASSES = (
    "FROZEN_PROJECT_TERMINALS_AND_SPECIFICATIONS",
    "BOUND_LOCAL_DR9_BRICK_IDENTITY_GEOMETRY",
    "OFFICIAL_NOIRLAB_DATALAB_SCHEMA_METADATA",
    "PROSPECTIVELY_CONTRACTED_SOURCE_METADATA",
)
FIREWALL_KEYS = (
...
POLICY_CORE_MEMBERS = (
    "OC3_SOURCE_METADATA_DESCRIPTIVE_PILOT_AUTONOMY_POLICY_CORE_CONTRACT_001.md",
    "oc3/oc3_source_metadata_descriptive_pilot_governor.py",
    "oc3/oc3lib/source_metadata_descriptive_pilot_governor.py",
)
...
RUNTIME_TREE_PREFIXES = ("oc3/cross_id_formalism_recovery/", "oc3/cross_id_offline_review_recovery/",
    "oc3/cross_observer_grouping/", "oc3/source_metadata_descriptive_pilot/")
...
def validate_policy_core_manifest(path: Path = POLICY_CORE_MANIFEST_PATH) -> dict[str, object]:
    ...
    if (set(value) != {"active_mutation_result", "contract", "files", "schema_version", "sealed"} or
            value.get("schema_version") != "OC3_SOURCE_METADATA_DESCRIPTIVE_PILOT_POLICY_CORE_MANIFEST_001" or
...
def validate_mandate(path: Path = MANDATE_PATH) -> dict[str, object]:
    ...
    if (set(value) != required or value.get("schema_version") != "OC3_SOURCE_METADATA_DESCRIPTIVE_PILOT_AUTONOMY_MANDATE_001" or
            ...
            value.get("autonomous_action_contract") != "OC3_SOURCE_METADATA_DESCRIPTIVE_PILOT_ACTION_CONTRACT_001" or
...
def validate_state(path: Path = STATE_PATH) -> dict[str, object]:
    ...
    if (set(value) != required or value.get("schema_version") != "OC3_SOURCE_METADATA_DESCRIPTIVE_PILOT_AUTONOMY_STATE_001" or
...
def validate_standing_authorization(path: Path, *, expected_initial_state_sha256: str,
    ...
    if (set(value) != required or value.get("schema_version") != "OC3_SOURCE_METADATA_DESCRIPTIVE_PILOT_STANDING_AUTHORIZATION_001" or
...
def validate_action_validation_receipt(binding: object, contract: dict[str, object]) -> dict[str, object]:
    ...
    if (set(receipt) != required or receipt.get("schema_version") != "OC3_SOURCE_METADATA_DESCRIPTIVE_PILOT_ACTION_VALIDATION_RECEIPT_001" or
...
def validate_autonomous_action_candidate(path: Path) -> tuple[dict[str, object], dict[str, object]]:
    ...
    if (not isinstance(contract, dict) or set(contract) != required or
            contract.get("schema_version") != "OC3_SOURCE_METADATA_DESCRIPTIVE_PILOT_ACTION_CONTRACT_001" or
...
def _registered_binding(candidate_path: Path, candidate: dict[str, object], contract: dict[str, object], *, first=False) -> dict[str, object]:
    return {"action_contract_schema":"OC3_SOURCE_METADATA_DESCRIPTIVE_PILOT_ACTION_CONTRACT_001","action_kind":contract["action_kind"],
...
def build_permit(*, candidate_path: Path, state_path: Path, standing_authorization_path: Path,
    ...
    return sealed({"action_kind":contract["action_kind"],"authorization_basis":"STANDING_SOURCE_METADATA_DESCRIPTIVE_PILOT_AUTONOMY_MANDATE_001",
        ...
        "schema_version":"OC3_SOURCE_METADATA_DESCRIPTIVE_PILOT_EXECUTION_PERMIT_001","scientific_firewall":contract["scientific_firewall"],
...
def validate_permit(permit_path: Path, *, candidate_path: Path, state_path: Path,
    ...
    if (set(permit) != required or permit.get("schema_version") != "OC3_SOURCE_METADATA_DESCRIPTIVE_PILOT_EXECUTION_PERMIT_001" or
            permit.get("permit_type") != "AUTONOMOUS_EXECUTION_PERMIT" or
            permit.get("authorization_basis") != "STANDING_SOURCE_METADATA_DESCRIPTIVE_PILOT_AUTONOMY_MANDATE_001" or
