...
AUTONOMY_BRANCH = "autopilot/source-metadata-acquisition-pilot"
...
SCIENTIFIC_SPEC_PATH = PROJECT / "OC3_SOURCE_METADATA_ACQUISITION_PILOT_SPEC_001.md"
SCIENTIFIC_SPEC_SHA256 = "8b34d426c1cfbd671c9fe1d13a874c2c2dd2233c0164ea12bb1708a9445886c4"
POLICY_CORE_CONTRACT_PATH = PROJECT / "OC3_SOURCE_METADATA_ACQUISITION_PILOT_AUTONOMY_POLICY_CORE_CONTRACT_001.md"
POLICY_CORE_MANIFEST_PATH = PROJECT / "oc3/INPUTS/OC3_SOURCE_METADATA_ACQUISITION_PILOT_POLICY_CORE_MANIFEST_001.json"
MANDATE_DOCUMENT_PATH = PROJECT / "OC3_SOURCE_METADATA_ACQUISITION_PILOT_AUTONOMY_MANDATE_001.md"
MANDATE_PATH = PROJECT / "oc3/INPUTS/OC3_SOURCE_METADATA_ACQUISITION_PILOT_AUTONOMY_MANDATE_001.json"
RUNBOOK_PATH = PROJECT / "OC3_SOURCE_METADATA_ACQUISITION_PILOT_AUTONOMOUS_RESEARCH_RUNBOOK_001.md"
STANDING_AUTHORIZATION_PATH = PROJECT / "oc3/OC3_SOURCE_METADATA_ACQUISITION_PILOT_STANDING_AUTHORIZATION_001.json"
AUTHORIZATION_PATH = STANDING_AUTHORIZATION_PATH
STATE_PATH = PROJECT / "oc3/OC3_SOURCE_METADATA_ACQUISITION_PILOT_AUTONOMY_STATE_001.json"
LEDGER_ROOT = PROJECT / "oc3/SOURCE_METADATA_ACQUISITION_PILOT_AUTONOMY_LEDGER"
CONSUMPTION_ROOT = LEDGER_ROOT / "PERMIT_CONSUMPTION"
PRIOR_FINAL_REPORT_PATH = PROJECT / "OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_FINAL_REPORT_001.md"
PRIOR_FINAL_REPORT_SHA256 = "6002a9f901d39dabbd1c5a77255df1286ddb177981db627f4c0093cc9c698764"
PRIOR_CLAIM_MATRIX_PATH = PROJECT / "oc3/OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_FINAL_CLAIM_MATRIX_001.json"
PRIOR_CLAIM_MATRIX_SHA256 = "8b4fe975730f24174436cc21cf27c8c1ea280b0f14b6452714a9ce35a0cff65d"
PRIOR_TERMINAL_STATE_PATH = PROJECT / "oc3/OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_AUTONOMY_STATE_001.json"
PRIOR_TERMINAL_STATE_SHA256 = "437414c0c4296865036d0c1d9546694e31663d6619303681faf71967a71756d7"
PRIOR_CONSUMPTION_MARKER_PATH = PROJECT / "oc3/SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_AUTONOMY_LEDGER/000004_SCIENTIFIC_TERMINAL.json"
PRIOR_CONSUMPTION_MARKER_SHA256 = "73bb1a846634a714dce9e24abdefbdd30c525d1b77978b0d79986cd5847c2d3f"
PILOT_FRAME_PATH = PROJECT / "oc3/source_metadata_pilot_frame_schema_recovery/OC3-SOURCE-METADATA-PILOT-FRAME-SCHEMA-RECOVERY-001/PILOT_FRAME.json"
PILOT_FRAME_SHA256 = "661f4d429f8fe0b6aa0104e093d79568d6f274935a7d9b0e78fb3dd45ae40292"
TERMINAL_COMMIT = "cf34a0efae274a198ac924f99da6135597a7d451"

TERMINAL_OUTCOMES = (
    "SOURCE_METADATA_ACQUISITION_COMPLETED",
    "SOURCE_METADATA_ACQUISITION_RESOURCE_BOUND",
    "SOURCE_METADATA_ACQUISITION_INCONCLUSIVE",
    "SOURCE_METADATA_ACQUISITION_INTEGRITY_FAILED",
)
AUTHORITY_CLASSES = (
    "FROZEN_PROJECT_TERMINALS_AND_SPECIFICATIONS",
    "FROZEN_PILOT_FRAME_IDENTITY_GEOMETRY",
    "OFFICIAL_NOIRLAB_DATALAB_PUBLIC_QUERY",
    "OFFICIAL_LEGACY_SURVEY_DR9_DOCUMENTATION",
)
FIREWALL_KEYS = (
    "holdout_count_requests", "holdout_row_requests", "holdout_source_derived_cells_observed",
    "PHOTSYS_reads", "TYPE_values_read", "DCHISQ_values_read", "Sersic_shape_values_read",
    "photometric_values_read", "photoz_values_read", "image_pixels_read",
    ...
    "matching_operations", "angular_separation_operations", "search_bound_selections", "scientific_threshold_selections",
    "object_group_ids_created", "split_group_ids_created", "combined_tractor_accesses",
    "crossmatch_operations", "q3c_operations", "cone_search_operations", "radius_query_operations",
)
...
POLICY_CORE_MEMBERS = (
    "OC3_SOURCE_METADATA_ACQUISITION_PILOT_AUTONOMY_POLICY_CORE_CONTRACT_001.md",
    "oc3/oc3_source_metadata_acquisition_pilot_governor.py",
    "oc3/oc3lib/source_metadata_acquisition_pilot_governor.py",
)
...
RUNTIME_TREE_PREFIXES = ("oc3/cross_id_formalism_recovery/", "oc3/cross_id_offline_review_recovery/",
    "oc3/cross_observer_grouping/", "oc3/source_metadata_pilot_frame_recovery/",
    "oc3/source_metadata_pilot_frame_schema_recovery/",
    "oc3/source_metadata_acquisition_pilot/")
...
def validate_policy_core_manifest(path: Path = POLICY_CORE_MANIFEST_PATH) -> dict[str, object]:
    ...
    if (set(value) != {"active_mutation_result", "contract", "files", "schema_version", "sealed"} or
            value.get("schema_version") != "OC3_SOURCE_METADATA_ACQUISITION_PILOT_POLICY_CORE_MANIFEST_001" or
...
def validate_mandate(path: Path = MANDATE_PATH) -> dict[str, object]:
    ...
    if (set(value) != required or value.get("schema_version") != "OC3_SOURCE_METADATA_ACQUISITION_PILOT_AUTONOMY_MANDATE_001" or
            ...
            value.get("autonomous_action_contract") != "OC3_SOURCE_METADATA_ACQUISITION_PILOT_ACTION_CONTRACT_001" or
            value.get("stop_state") != STOP_REQUIRES_HUMAN):
        raise GovernorError("AUTONOMY_MANDATE_INVALID")
    if value.get("budgets") != {"application_body_bytes_parent":67108864,
        "application_body_bytes_remaining":67108864,"concurrency":1,
        "network_requests_parent":5,"network_requests_remaining":5,
...
def validate_static_authorities() -> dict[str, str]:
    for path, digest in (
            ...
            (PRIOR_CONSUMPTION_MARKER_PATH, PRIOR_CONSUMPTION_MARKER_SHA256),
            (PILOT_FRAME_PATH, PILOT_FRAME_SHA256)):
        if not path.is_file() or file_sha256(path) != digest:
            raise GovernorError("AUTONOMY_STATIC_AUTHORITY_MISMATCH")
    commit = subprocess.run(["git", "cat-file", "-e", f"{TERMINAL_COMMIT}^{{commit}}"],
                            cwd=PROJECT, capture_output=True)
    ancestor = subprocess.run(["git", "merge-base", "--is-ancestor", TERMINAL_COMMIT, "HEAD"],
                              cwd=PROJECT, capture_output=True)
    if commit.returncode != 0 or ancestor.returncode != 0:
        raise GovernorError("AUTONOMY_TERMINAL_COMMIT_MISMATCH")
    ...
    return {_relative(SCIENTIFIC_SPEC_PATH):SCIENTIFIC_SPEC_SHA256,
            ...
            _relative(PRIOR_CONSUMPTION_MARKER_PATH):PRIOR_CONSUMPTION_MARKER_SHA256,
            _relative(PILOT_FRAME_PATH):PILOT_FRAME_SHA256,
...
def validate_state(path: Path = STATE_PATH) -> dict[str, object]:
    ...
    if (set(value) != required or value.get("schema_version") != "OC3_SOURCE_METADATA_ACQUISITION_PILOT_AUTONOMY_STATE_001" or
            ...
            value.get("request_budget_parent") != 5 or value.get("body_budget_parent") != 67108864):
    ...
    if (type(value.get("requests_remaining")) is not int or not 0 <= value["requests_remaining"] <= 5 or
            type(value.get("body_budget_remaining")) is not int or not 0 <= value["body_budget_remaining"] <= 67108864):
...
def validate_standing_authorization(path: Path, *, expected_initial_state_sha256: str,
    ...
    if (set(value) != required or value.get("schema_version") != "OC3_SOURCE_METADATA_ACQUISITION_PILOT_STANDING_AUTHORIZATION_001" or
...
def validate_action_validation_receipt(binding: object, contract: dict[str, object]) -> dict[str, object]:
    ...
    if (set(receipt) != required or receipt.get("schema_version") != "OC3_SOURCE_METADATA_ACQUISITION_PILOT_ACTION_VALIDATION_RECEIPT_001" or
...
def validate_autonomous_action_candidate(path: Path) -> tuple[dict[str, object], dict[str, object]]:
    ...
    if (not isinstance(contract, dict) or set(contract) != required or
            contract.get("schema_version") != "OC3_SOURCE_METADATA_ACQUISITION_PILOT_ACTION_CONTRACT_001" or
...
def _registered_binding(candidate_path: Path, candidate: dict[str, object], contract: dict[str, object], *, first=False) -> dict[str, object]:
    return {"action_contract_schema":"OC3_SOURCE_METADATA_ACQUISITION_PILOT_ACTION_CONTRACT_001","action_kind":contract["action_kind"],
...
def build_permit(*, candidate_path: Path, state_path: Path, standing_authorization_path: Path,
    ...
    return sealed({"action_kind":contract["action_kind"],"authorization_basis":"STANDING_SOURCE_METADATA_ACQUISITION_PILOT_AUTONOMY_MANDATE_001",
        ...
        "schema_version":"OC3_SOURCE_METADATA_ACQUISITION_PILOT_EXECUTION_PERMIT_001","scientific_firewall":contract["scientific_firewall"],
...
def validate_permit(permit_path: Path, *, candidate_path: Path, state_path: Path,
    ...
    if (set(permit) != required or permit.get("schema_version") != "OC3_SOURCE_METADATA_ACQUISITION_PILOT_EXECUTION_PERMIT_001" or
            permit.get("permit_type") != "AUTONOMOUS_EXECUTION_PERMIT" or
            permit.get("authorization_basis") != "STANDING_SOURCE_METADATA_ACQUISITION_PILOT_AUTONOMY_MANDATE_001" or
