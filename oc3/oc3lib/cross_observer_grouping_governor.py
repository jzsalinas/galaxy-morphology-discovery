...
MISSION_ID = "OC3-CROSS-OBSERVER-GROUPING-AUTONOMY-001"
MISSION_SCOPE = "CROSS_OBSERVER_GROUPING_RESEARCH_ONLY"
AUTONOMY_BRANCH = "autopilot/cross-observer-grouping"
...
HISTORICAL_POLICY_MANIFEST_SHA256 = "b10ffe799df90398209aa32bf623bfb43528f31202a65146f10b24c4f7e3b1ff"
...
AUTHORITY_CLASSES = (
    ...
    "OFFICIAL_NOIRLAB_DATALAB_DOCUMENTATION",
    "PRIMARY_CROSS_IDENTIFICATION_LITERATURE",
    "BOUND_LOCAL_GLOBAL_VIEW_RELATION_EVIDENCE",
    "PROSPECTIVELY_CONTRACTED_SOURCE_METADATA",
    "PROSPECTIVELY_CONTRACTED_VALIDATION_ANCHORS",
)
FIREWALL_KEYS = (
...
RUNTIME_TREE_PREFIXES = ("oc3/cross_observer_grouping/",)
...
def build_permit(*, candidate_path: Path, state_path: Path, standing_authorization_path: Path,
    ...
    return sealed({"action_kind":contract["action_kind"],"authorization_basis":"STANDING_CROSS_OBSERVER_GROUPING_AUTONOMY_MANDATE_002",
        ...
        "schema_version":"OC3_CROSS_OBSERVER_GROUPING_EXECUTION_PERMIT_002","scientific_firewall":contract["scientific_firewall"],
