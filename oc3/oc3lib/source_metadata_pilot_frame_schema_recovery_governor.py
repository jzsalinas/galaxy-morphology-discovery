...
MISSION_SCOPE = "OFFLINE_PILOT_FRAME_SCHEMA_RECOVERY_ONLY"
AUTONOMY_BRANCH = "autopilot/source-metadata-frame-schema-recovery"
...
SCIENTIFIC_SPEC_PATH = PROJECT / "OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_SPEC_001.md"
SCIENTIFIC_SPEC_SHA256 = "350af50ce508c49a612dfc97191529159d9ae10e8151260ed751b19e3b2e0df7"
POLICY_CORE_CONTRACT_PATH = PROJECT / "OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_AUTONOMY_POLICY_CORE_CONTRACT_001.md"
POLICY_CORE_MANIFEST_PATH = PROJECT / "oc3/INPUTS/OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_POLICY_CORE_MANIFEST_001.json"
MANDATE_DOCUMENT_PATH = PROJECT / "OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_AUTONOMY_MANDATE_001.md"
MANDATE_PATH = PROJECT / "oc3/INPUTS/OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_AUTONOMY_MANDATE_001.json"
RUNBOOK_PATH = PROJECT / "OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_AUTONOMOUS_RESEARCH_RUNBOOK_001.md"
STANDING_AUTHORIZATION_PATH = PROJECT / "oc3/OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_STANDING_AUTHORIZATION_001.json"
AUTHORIZATION_PATH = STANDING_AUTHORIZATION_PATH
STATE_PATH = PROJECT / "oc3/OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_AUTONOMY_STATE_001.json"
LEDGER_ROOT = PROJECT / "oc3/SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_AUTONOMY_LEDGER"
CONSUMPTION_ROOT = LEDGER_ROOT / "PERMIT_CONSUMPTION"
PRIOR_FINAL_REPORT_PATH = PROJECT / "OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_FINAL_REPORT_001.md"
PRIOR_FINAL_REPORT_SHA256 = "077863f9b7c87c826c5f18b01b91c79af680604874069c546db8cbef16fb09b9"
PRIOR_CLAIM_MATRIX_PATH = PROJECT / "oc3/OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_FINAL_CLAIM_MATRIX_001.json"
PRIOR_CLAIM_MATRIX_SHA256 = "60d64686ec16e424bf744eb015fd30f650a2c016de31e9265cf8667c27f67a4e"
PRIOR_TERMINAL_STATE_PATH = PROJECT / "oc3/OC3_SOURCE_METADATA_PILOT_FRAME_RECOVERY_AUTONOMY_STATE_001.json"
PRIOR_TERMINAL_STATE_SHA256 = "2197a8fe6c5cb41e0a14497943f8967ea16cb7d4f682f3d870b8d290810c6c14"
PRIOR_CONSUMPTION_MARKER_PATH = PROJECT / "oc3/SOURCE_METADATA_PILOT_FRAME_RECOVERY_AUTONOMY_LEDGER/000003_ACTION_COMPLETE.json"
PRIOR_CONSUMPTION_MARKER_SHA256 = "38ea2a9cf0904448ffe240f6535a8c5cd264a310ac411120064d432129410bc9"

TERMINAL_OUTCOMES = (
    "SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERED",
    "SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_INTEGRITY_FAILED",
    "SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_INCONCLUSIVE",
)
AUTHORITY_CLASSES = (
    "FROZEN_PROJECT_TERMINALS_AND_SPECIFICATIONS",
    "BOUND_LOCAL_DR9_BRICK_IDENTITY_GEOMETRY",
    "FROZEN_PROVIDER_PHYSICAL_CONTRACTS",
)
FIREWALL_KEYS = (
    "network_requests", "source_rows_read", "datalab_accesses",
    ...
    "server_crossmatch_operations", "radius_query_operations",
)
...
POLICY_CORE_MEMBERS = (
    "OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_AUTONOMY_POLICY_CORE_CONTRACT_001.md",
    "oc3/oc3_source_metadata_pilot_frame_schema_recovery_governor.py",
    "oc3/oc3lib/source_metadata_pilot_frame_schema_recovery_governor.py",
)
...
def validate_policy_core_manifest(path: Path = POLICY_CORE_MANIFEST_PATH) -> dict[str, object]:
    ...
    if (set(value) != {"active_mutation_result", "contract", "files", "schema_version", "sealed"} or
            value.get("schema_version") != "OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_POLICY_CORE_MANIFEST_001" or
...
def validate_mandate(path: Path = MANDATE_PATH) -> dict[str, object]:
    ...
    if (set(value) != required or value.get("schema_version") != "OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_AUTONOMY_MANDATE_001" or
            ...
            value.get("autonomous_action_contract") != "OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_ACTION_CONTRACT_001" or
...
def validate_state(path: Path = STATE_PATH) -> dict[str, object]:
    ...
    if (set(value) != required or value.get("schema_version") != "OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_AUTONOMY_STATE_001" or
...
def validate_standing_authorization(path: Path, *, expected_initial_state_sha256: str,
    ...
    if (set(value) != required or value.get("schema_version") != "OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_STANDING_AUTHORIZATION_001" or
...
def validate_action_validation_receipt(binding: object, contract: dict[str, object]) -> dict[str, object]:
    ...
    if (set(receipt) != required or receipt.get("schema_version") != "OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_ACTION_VALIDATION_RECEIPT_001" or
...
def validate_autonomous_action_candidate(path: Path) -> tuple[dict[str, object], dict[str, object]]:
    ...
    if (not isinstance(contract, dict) or set(contract) != required or
            contract.get("schema_version") != "OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_ACTION_CONTRACT_001" or
...
def _registered_binding(candidate_path: Path, candidate: dict[str, object], contract: dict[str, object], *, first=False) -> dict[str, object]:
    return {"action_contract_schema":"OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_ACTION_CONTRACT_001","action_kind":contract["action_kind"],
...
def build_permit(*, candidate_path: Path, state_path: Path, standing_authorization_path: Path,
    ...
    return sealed({"action_kind":contract["action_kind"],"authorization_basis":"STANDING_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_AUTONOMY_MANDATE_001",
        ...
        "schema_version":"OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_EXECUTION_PERMIT_001","scientific_firewall":contract["scientific_firewall"],
...
def validate_permit(permit_path: Path, *, candidate_path: Path, state_path: Path,
    ...
    if (set(permit) != required or permit.get("schema_version") != "OC3_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_EXECUTION_PERMIT_001" or
            permit.get("permit_type") != "AUTONOMOUS_EXECUTION_PERMIT" or
            permit.get("authorization_basis") != "STANDING_SOURCE_METADATA_PILOT_FRAME_SCHEMA_RECOVERY_AUTONOMY_MANDATE_001" or
