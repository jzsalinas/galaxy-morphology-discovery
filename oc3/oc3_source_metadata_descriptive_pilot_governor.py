#!/usr/bin/env python3
"""Offline CLI for the frozen OC3 source-metadata descriptive pilot autonomy engine."""
...
from oc3lib.source_metadata_descriptive_pilot_governor import (
...
def parser() -> argparse.ArgumentParser:
    result=argparse.ArgumentParser(description="Deterministic offline OC3 source-metadata descriptive pilot autonomy governor")
