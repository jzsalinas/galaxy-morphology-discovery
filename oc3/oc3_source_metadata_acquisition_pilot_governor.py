#!/usr/bin/env python3
"""Offline CLI for the frozen OC3 supervised source-metadata acquisition governor."""
...
from oc3lib.source_metadata_acquisition_pilot_governor import (
...
def parser() -> argparse.ArgumentParser:
    result=argparse.ArgumentParser(description="Deterministic offline OC3 source-metadata acquisition autonomy governor")
